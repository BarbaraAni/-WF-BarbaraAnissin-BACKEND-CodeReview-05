...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 21. Jan 2020 um 15:24
...
INSERT INTO `car` (`car_id`, `seats`, `available`) VALUES
(1, 4, 1),
(2, 5, 1),
(3, 4, 1),
(4, 5, 1);
...
INSERT INTO `charges` (`charge_id`, `charge_amount`) VALUES
(1, 50),
(2, 10),
(3, 70),
(4, 1000),
...
INSERT INTO `invoice` (`invoice_id`, `amount`, `fk_charges_id`, `fk_user_id`, `fk_return_id`) VALUES
(1, 20, 4, 2, 1);
...
INSERT INTO `pickup` (`pickup_id`, `start_date`, `location`, `fk_car_id`) VALUES
(1, '2020-01-20', 'VIENN', 1),
(2, '2020-01-19', 'LINZ', 1);
...
INSERT INTO `reservation` (`reservation_id`, `fk_user_id`, `fk_pickup_id`) VALUES
(1, 1, 2),
(2, 4, 1);
...
--
-- Daten für Tabelle `returning`
--

INSERT INTO `returning` (`return_id`, `end_date`, `fk_car_id`) VALUES
(1, '2020-01-23', 2);
